...
public class Constants {
    ...
    public final static int[] CUP_COLOR_NAME = {R.string.color_0, R.string.color_1, R.string.color_2, R.string.color_3, R.string.color_4, R.string.color_5, R.string.color_6};
