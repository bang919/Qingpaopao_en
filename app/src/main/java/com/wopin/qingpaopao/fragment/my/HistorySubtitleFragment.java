...
public class HistorySubtitleFragment extends BaseBarDialogFragment implements ExploreListAdapter.ExploreListItemClick {

    public static final String TAG = "HistorySubtitleFragment";
    ...
    protected void initEvent() {
        ...
        exploreModel.listHistoryExplores().subscribe(new Observer<ExploreListRsp>() {
            @Override
