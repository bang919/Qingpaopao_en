...
public class FollowSubtitleFragment extends BaseBarDialogFragment implements ExploreListAdapter.ExploreListItemClick {

    public static final String TAG = "FollowSubtitleFragment";
    ...
    protected void initEvent() {
        ...
        exploreModel.listFollowExplores().subscribe(new Observer<ExploreListRsp>() {
            @Override
